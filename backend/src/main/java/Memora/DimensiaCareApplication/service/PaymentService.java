...
public class PaymentService {
    ...
    public Payment updatePaymentStatus(Long paymentId, String status, String transactionId) {
        return updatePaymentStatus(paymentId, status, transactionId, null, null);
    }

    public Payment updatePaymentStatus(Long paymentId, String status, String transactionId, Long patientId,
        ...
        if (optionalPayment.isPresent()) {
            ...
            // If payment successful, add paid subscription period
            if (status.equalsIgnoreCase("SUCCESS") && patientId != null && durationMonths != null) {
                try {
                    subscriptionService.addPaidSubscription(patientId, durationMonths);
                } catch (Exception e) {
                    System.err.println(
                            "Failed to add paid subscription for patient " + patientId + ": " + e.getMessage());
                }
            }
    ...
    public Payment updatePaymentStatusByOrderId(String payhereOrderId, String status, String transactionId) {
        return updatePaymentStatusByOrderId(payhereOrderId, status, transactionId, null, null);
    }

    public Payment updatePaymentStatusByOrderId(String payhereOrderId, String status, String transactionId,
            Long patientId, Integer durationMonths) {
