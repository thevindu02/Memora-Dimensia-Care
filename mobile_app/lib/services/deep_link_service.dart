...
class DeepLinkService {
  ...
  static Future<void> initialize(GlobalKey<NavigatorState> navigatorKey) async {
    ...
    if (initialUri != null) {
      ...
      if (initialUri.scheme == 'memora' && 
          (initialUri.host == 'reset-password' || initialUri.host == 'guardian-request')) {
  ...
  static Future<void> initializeFromDashboard(GlobalKey<NavigatorState> navigatorKey) async {
  ...
  static void _handleDeepLink(Uri uri) {
    ...
    print('DeepLinkService: Scheme: ${uri.scheme}, Host: ${uri.host}, Path: ${uri.path}');
    ...
    if (_navigatorKey?.currentState != null) {
      ...
      if (token != null && token.isNotEmpty) {
        ...
        if (uri.host == 'reset-password') {
          print('DeepLinkService: Navigating to reset password screen with token');
          _navigatorKey!.currentState!.pushNamed(
            AppRoutes.resetPassword,
            arguments: {'token': token},
          );
        } else if (uri.host == 'guardian-request') {
          print('DeepLinkService: Navigating to guardian request screen with token');
          _navigatorKey!.currentState!.pushNamed(
        ...
        print('DeepLinkService: No token found, navigating to root');
        _navigatorKey!.currentState!.pushNamed('/');
      }
    } else {
