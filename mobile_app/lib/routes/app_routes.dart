class AppRoutes {
  ...
  static const String caregiverConnectionRequests = '/caregiver-connection-requests';
  ...
  static const String caregiverSettingsHelpSupport = '/caregiver/settings/help_support';
