...
import 'guardian_single_article_screen.dart';
import '../../services/article_service.dart';

class GuardianArticlesTabBody extends StatefulWidget {
  @override
  _GuardianArticlesTabBodyState createState() =>
      _GuardianArticlesTabBodyState();
}

class _GuardianArticlesTabBodyState extends State<GuardianArticlesTabBody> {
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => GuardianSingleArticleScreen(
